          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="px-6 py-3 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors shadow-lg hover:shadow-xl whitespace-nowrap cursor-pointer w-full sm:w-auto"
              >
                {isAuthenticating ? (
